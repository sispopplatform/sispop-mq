...
std::pair<zmq::socket_t *, std::string> SispopMQ::proxy_connect_sn(bt_dict_consumer data) {
...
void SispopMQ::proxy_close_connection(size_t index, std::chrono::milliseconds linger) {
...
void SispopMQ::proxy_connect_remote(bt_dict_consumer data) {
...
void SispopMQ::proxy_disconnect(bt_dict_consumer data) {
